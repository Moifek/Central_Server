...
{
    [Table("GrhEmployeeCategory")]
    public partial class GrhEmployeeCategory
    {
        public GrhEmployeeCategory()
        {
        ...
        [InverseProperty("GrhEmployeeCategories")]
        public virtual CfgCompany CfgCompany { get; set; }
        [InverseProperty(nameof(CfgTier.GrhEmployeeCategory))]
        public virtual ICollection<CfgTier> CfgTiers { get; set; }
        [InverseProperty(nameof(GrhEmployeeHistory.GrhEmployeeCategory))]
        public virtual ICollection<GrhEmployeeHistory> GrhEmployeeHistories { get; set; }
        [InverseProperty(nameof(GrhPaySlip.GrhEmployeeCategory))]
