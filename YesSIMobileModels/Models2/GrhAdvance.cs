...
namespace YesSIMobileModels.Models2
{
    ...
    public partial class GrhAdvance
    {
        public GrhAdvance()
        {
            GrhAdvanceLines = new HashSet<GrhAdvanceLine>();
        }
        ...
        [InverseProperty(nameof(GrhAdvanceLine.GrhAdvance))]
        public virtual ICollection<GrhAdvanceLine> GrhAdvanceLines { get; set; }
    }
}
