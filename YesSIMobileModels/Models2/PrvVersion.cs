...
namespace YesSIMobileModels.Models2
{
    ...
    public partial class PrvVersion
    {
        ...
        [InverseProperty(nameof(PrvSettlementPrevision.PrvVersion))]
        public virtual ICollection<PrvSettlementPrevision> PrvSettlementPrevisions { get; set; }
        [InverseProperty(nameof(PrvTurnoverPrevision.PrvVersion))]
        public virtual ICollection<PrvTurnoverPrevision> PrvTurnoverPrevisions { get; set; }
        [InverseProperty(nameof(StkFeasibilityStudy.PrvVersion))]
