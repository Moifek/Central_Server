...
{
    [Table("ComActionMessageSubCategoryStatus")]
    public partial class ComActionMessageSubCategoryStatus
    {
        public ComActionMessageSubCategoryStatus()
        {
        ...
        [InverseProperty(nameof(ComActionMessageSubCategory.ComActionMessageSubCategoryStatus))]
