...
{
    [Keyless]
    public partial class StlDocumentView
    {
        [Column("PKey")]
        ...
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AmountComDocumentSettled { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AmountRntDocumentSettled { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AmountDocumentSettled { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AmountFolderSettled { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
