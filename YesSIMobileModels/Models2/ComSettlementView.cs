...
{
    [Keyless]
    public partial class ComSettlementView
    {
        [Column("PKey")]
        ...
        [StringLength(255)]
        public string CfgtierTierOtherDescription { get; set; }
        [StringLength(255)]
        public string CfgtierTierOtherCode { get; set; }
        public Guid? CfgLawyerId { get; set; }
        [StringLength(255)]
        public string CfgtiercfgLawyerDescription { get; set; }
        [StringLength(255)]
        public string CfgtiercfgLawyerCode { get; set; }
