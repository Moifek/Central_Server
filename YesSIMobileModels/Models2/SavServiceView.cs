...
{
    [Keyless]
    public partial class SavServiceView
    {
        [Column("PKey")]
        ...
        [StringLength(255)]
        public string CfgServiceManagerCode { get; set; }
        [StringLength(255)]
        public string CfgServiceManagerDescription { get; set; }
        ...
        [StringLength(255)]
        public string StlItemGroupCode { get; set; }
        [StringLength(500)]
        public string StlItemGroupDescription { get; set; }
        [StringLength(255)]
