...
{
    [Keyless]
    public partial class ComSaleMonitoringView
    {
        ...
        [Column("ItemPriceBeforeDiscountHT", TypeName = "decimal(38, 12)")]
        public decimal? ItemPriceBeforeDiscountHt { get; set; }
        [Column("UnderItemsPriceBeforeDiscountHT", TypeName = "decimal(27, 6)")]
        public decimal? UnderItemsPriceBeforeDiscountHt { get; set; }
        [Column("PriceBeforeDiscountHT", TypeName = "decimal(38, 12)")]
        ...
        [Column("ItemPriceHT", TypeName = "decimal(38, 12)")]
        public decimal? ItemPriceHt { get; set; }
        [Column("UnderItemsPriceHT", TypeName = "decimal(38, 11)")]
        ...
        [Column("UnderItemsPriceTTC", TypeName = "decimal(27, 6)")]
        ...
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? TotalToPaySettled { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? TotalToPayRest { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        ...
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AdvanceRatioReal { get; set; }
        [Column(TypeName = "decimal(38, 6)")]
        public decimal? AgreementRatioReal { get; set; }
