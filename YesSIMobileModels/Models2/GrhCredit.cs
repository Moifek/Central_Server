...
namespace YesSIMobileModels.Models2
{
    ...
    public partial class GrhCredit
    {
        public GrhCredit()
        {
            GrhCreditLines = new HashSet<GrhCreditLine>();
        }
        ...
        [InverseProperty(nameof(GrhCreditLine.GrhCredit))]
        public virtual ICollection<GrhCreditLine> GrhCreditLines { get; set; }
    }
}
