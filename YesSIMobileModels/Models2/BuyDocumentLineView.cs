...
{
    [Keyless]
    public partial class BuyDocumentLineView
    {
        ...
        [StringLength(255)]
        public string ParentOfferCode { get; set; }
        [StringLength(255)]
        public string ParentOfferDescription { get; set; }
        public int? ParentOfferSorting { get; set; }
